...
public class BuildingUtils {
    ...
    public static Building createInstance(int numberOfFloors,
                                          int[] numberOfRoomsOnFloor,
                                          String nameOfBuilding)
    {
        return buildingFactory
                .createInstance(numberOfFloors, numberOfRoomsOnFloor, nameOfBuilding);
    }
            ...
            throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException
    {
        ...
        Constructor<? extends Building> constructor = buildingClass
                .getConstructor(classes);
        return constructor
                .newInstance(numberOfFloors, numberOfRoomsOnFloor, nameOfBuilding);
    }
            ...
            InstantiationException, IllegalAccessException
    {
        ...
        return createInstance(numberOfFloors, numberOfRoomsOnFloor,
                nameOfBuilding, buildingClass);
    }
    ...
    public static void printFloorDTOListToFile(List<FloorDTO> floors,
                                               Writer out)
    {
        Formatter formatter = new Formatter(out);
        formatter.format("%d %n", floors.size());
        floors.stream().forEach((floor) ->
                formatter.format("%s %d %n", floor.getNameOfBuilding(),
                        floor.getNumberOfRoomsOnFloor()));
    }

    public static void serializeBuilding(Building building, String fileName)
            throws GeneralInputException
    {
    ...
    public static Building deserializeBuilding(String fileName)
            throws GeneralInputException
    {
    ...
    {
        Collections.sort(buildings, Comparator.comparing(Building::getNumberOfFloors));
    }

    public static void sortBuildingsByNameOfBuilding(List<Building> buildings)
    {

        Collections.sort(buildings, Comparator.comparing(Building::getNameOfBuilding));
    }
